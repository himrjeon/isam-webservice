...
import kr.seoulautogallery.config.auth.dto.OAuthAttributes;
import kr.seoulautogallery.config.auth.dto.SessionUser;
import kr.seoulautogallery.domain.user.User;
import kr.seoulautogallery.domain.user.UserRepository;
